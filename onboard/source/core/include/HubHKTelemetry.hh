...
public:
  ...
  inline void setLastCommandCodeHub(uint16_t v) {
    lastCommandCodeHub_ = v;
  }
  inline uint16_t LastCommandCodeHub() const {
    return lastCommandCodeHub_;
  }

  inline void setLastCommandIndexHub(uint32_t v) {
    lastCommandIndexHub_ = v;
  }
  inline uint32_t LastCommandIndexHub() const {
    return lastCommandIndexHub_;
  }

  inline void setCommandRejectedIndexHub(uint32_t v) {
    commandRejectedIndexHub_ = v;
  }
  inline uint32_t CommandRejectedIndexHub() const {
    return commandRejectedIndexHub_;
  }

  inline void setLastCommandCodeOrc(uint16_t v) {
    lastCommandCodeOrc_ = v;
  }
  inline uint16_t LastCommandCodeOrc() const {
    return lastCommandCodeOrc_;
  }

  inline void setLastCommandIndexOrc(uint32_t v) {
    lastCommandIndexOrc_ = v;
  }
  inline uint32_t LastCommandIndexOrc() const {
    return lastCommandIndexOrc_;
  }

  inline void setCommandRejectedIndexOrc(uint32_t v) {
    commandRejectedIndexOrc_ = v;
  }
  inline uint32_t CommandRejectedIndexOrc() const {
    return commandRejectedIndexOrc_;
  }

  inline void setLastCommandCodeTPC(uint16_t v) {
    lastCommandCodeTPC_ = v;
  }
  inline uint16_t LastCommandCodeTPC() const {
    return lastCommandCodeTPC_;
  }

  inline void setLastCommandIndexTPC(uint32_t v) {
    lastCommandIndexTPC_ = v;
  }
  inline uint32_t LastCommandIndexTPC() const {
    return lastCommandIndexTPC_;
  }

  inline void setCommandRejectedIndexTPC(uint32_t v) {
    commandRejectedIndexTPC_ = v;
  }
  inline uint32_t CommandRejectedIndexTPC() const {
    return commandRejectedIndexTPC_;
  }

  inline void setLastCommandCodeTOF(uint16_t v) {
    lastCommandCodeTOF_ = v;
  }
  inline uint16_t LastCommandCodeTOF() const {
    return lastCommandCodeTOF_;
  }

  inline void setLastCommandIndexTOF(uint32_t v) {
    lastCommandIndexTOF_ = v;
  }
  inline uint32_t LastCommandIndexTOF() const {
    return lastCommandIndexTOF_;
  }

  inline void setCommandRejectedIndexTOF(uint32_t v) {
    commandRejectedIndexTOF_ = v;
  }
  inline uint32_t CommandRejectedIndexTOF() const {
    return commandRejectedIndexTOF_;
  }

  inline void setLastCommandCodeQM(uint16_t v) {
    lastCommandCodeQM_ = v;
  }
  inline uint16_t LastCommandCodeQM() const {
    return lastCommandCodeQM_;
  }

  inline void setLastCommandIndexQM(uint32_t v) {
    lastCommandIndexQM_ = v;
  }
  inline uint32_t LastCommandIndexQM() const {
    return lastCommandIndexQM_;
  }

  inline void setCommandRejectedIndexQM(uint32_t v) {
    commandRejectedIndexQM_ = v;
  }
  inline uint32_t CommandRejectedIndexQM() const {
    return commandRejectedIndexQM_;
  }
  ...
  inline uint16_t PduCurTPCHV() const {
    return pduCurTPCHV_;
  }

  inline void setPduVolTPCHV(uint16_t v) {
    pduVolTPCHV_ = v;
  }
  inline uint16_t PduVolTPCHV() const {
    return pduVolTPCHV_;
  }
  ...
  inline uint16_t PduCommsBoardTemp() const {
    return pduCommsBoardTemp_;
  }

  inline void setPduSiPMPreAmpP2V5Vol(uint16_t v) {
    pduSiPMPreAmpP2V5Vol_ = v;
  }
  inline uint16_t PduSiPMPreAmpP2V5Vol() const {
    return pduSiPMPreAmpP2V5Vol_;
  }

  inline void setPduSiPMPreAmpP2V5Cur(uint16_t v) {
    pduSiPMPreAmpP2V5Cur_ = v;
  }
  inline uint16_t PduSiPMPreAmpP2V5Cur() const {
    return pduSiPMPreAmpP2V5Cur_;
  }

  inline void setPduSiPMPreAmpM5VVol(uint16_t v) {
    pduSiPMPreAmpM5VVol_ = v;
  }
  inline uint16_t PduSiPMPreAmpM5VVol() const {
    return pduSiPMPreAmpM5VVol_;
  }

  inline void setPduSiPMPreAmpM5VCur(uint16_t v) {
    pduSiPMPreAmpM5VCur_ = v;
  }
  inline uint16_t PduSiPMPreAmpM5VCur() const {
    return pduSiPMPreAmpM5VCur_;
  }

  inline void setPduSiPMPreAmpTemp(uint16_t v) {
    pduSiPMPreAmpTemp_ = v;
  }
  inline uint16_t PduSiPMPreAmpTemp() const {
    return pduSiPMPreAmpTemp_;
  }

  inline void setPduChargePreAmpP5VVol(uint16_t v) {
    pduChargePreAmpP5VVol_ = v;
  }
  inline uint16_t PduChargePreAmpP5VVol() const {
    return pduChargePreAmpP5VVol_;
  }

  inline void setPduChargePreAmpP5VCur(uint16_t v) {
    pduChargePreAmpP5VCur_ = v;
  }
  inline uint16_t PduChargePreAmpP5VCur() const {
    return pduChargePreAmpP5VCur_;
  }

  inline void setPduChargePreAmpM5VVol(uint16_t v) {
    pduChargePreAmpM5VVol_ = v;
  }
  inline uint16_t PduChargePreAmpM5VVol() const {
    return pduChargePreAmpM5VVol_;
  }

  inline void setPduChargePreAmpM5VCur(uint16_t v) {
    pduChargePreAmpM5VCur_ = v;
  }
  inline uint16_t PduChargePreAmpM5VCur() const {
    return pduChargePreAmpM5VCur_;
  }

  inline void setPduChargePreAmpTemp(uint16_t v) {
    pduChargePreAmpTemp_ = v;
  }
  inline uint16_t PduChargePreAmpTemp() const {
    return pduChargePreAmpTemp_;
  }

  inline void setPduTofBiasP5V0Vol(uint16_t v) {
    pduTofBiasP5V0Vol_ = v;
  }
  inline uint16_t PduTofBiasP5V0Vol() const {
    return pduTofBiasP5V0Vol_;
  }

  inline void setPduTofBiasP5V0Cur(uint16_t v) {
    pduTofBiasP5V0Cur_ = v;
  }
  inline uint16_t PduTofBiasP5V0Cur() const {
    return pduTofBiasP5V0Cur_;
  }

  inline void setPduTofBiasP5V1Vol(uint16_t v) {
    pduTofBiasP5V1Vol_ = v;
  }
  inline uint16_t PduTofBiasP5V1Vol() const {
    return pduTofBiasP5V1Vol_;
  }

  inline void setPduTofBiasP5V1Cur(uint16_t v) {
    pduTofBiasP5V1Cur_ = v;
  }
  inline uint16_t PduTofBiasP5V1Cur() const {
    return pduTofBiasP5V1Cur_;
  }

  inline void setPduTofBiasP5VTemp(uint16_t v) {
    pduTofBiasP5VTemp_ = v;
  }
  inline uint16_t PduTofBiasP5VTemp() const {
    return pduTofBiasP5VTemp_;
  }

  inline void setPduTofP12VVol(uint16_t v) {
    pduTofP12VVol_ = v;
  }
  inline uint16_t PduTofP12VVol() const {
    return pduTofP12VVol_;
  }

  inline void setPduTofP12VCur(uint16_t v) {
    pduTofP12VCur_ = v;
  }
  inline uint16_t PduTofP12VCur() const {
    return pduTofP12VCur_;
  }

  inline void setPduCaenNevisP12VVol(uint16_t v) {
    pduCaenNevisP12VVol_ = v;
  }
  inline uint16_t PduCaenNevisP12VVol() const {
    return pduCaenNevisP12VVol_;
  }

  inline void setPduCaenNevisP12VCur(uint16_t v) {
    pduCaenNevisP12VCur_ = v;
  }
  inline uint16_t PduCaenNevisP12VCur() const {
    return pduCaenNevisP12VCur_;
  }

  inline void setPduCaenNevisM5VVol(uint16_t v) {
    pduCaenNevisM5VVol_ = v;
  }
  inline uint16_t PduCaenNevisM5VVol() const {
    return pduCaenNevisM5VVol_;
  }

  inline void setPduCaenNevisM5VCur(uint16_t v) {
    pduCaenNevisM5VCur_ = v;
  }
  inline uint16_t PduCaenNevisM5VCur() const {
    return pduCaenNevisM5VCur_;
  }

  inline void setPduCaenNevisP5VCur(uint16_t v) {
    pduCaenNevisP5VCur_ = v;
  }
  inline uint16_t PduCaenNevisP5VCur() const {
    return pduCaenNevisP5VCur_;
  }

  inline void setPduCaenNevisP5VVol(uint16_t v) {
    pduCaenNevisP5VVol_ = v;
  }
  inline uint16_t PduCaenNevisP5VVol() const {
    return pduCaenNevisP5VVol_;
  }

  inline void setPduCaenNevisP3V3Cur(uint16_t v) {
    pduCaenNevisP3V3Cur_ = v;
  }
  inline uint16_t PduCaenNevisP3V3Cur() const {
    return pduCaenNevisP3V3Cur_;
  }

  inline void setPduCaenNevisP3V3Vol(uint16_t v) {
    pduCaenNevisP3V3Vol_ = v;
  }
  inline uint16_t PduCaenNevisP3V3Vol() const {
    return pduCaenNevisP3V3Vol_;
  }

  inline void setPduShaperP3V3Vol(uint16_t v) {
    pduShaperP3V3Vol_ = v;
  }
  inline uint16_t PduShaperP3V3Vol() const {
    return pduShaperP3V3Vol_;
  }

  inline void setPduCaenNevisPM5VTemp(uint16_t v) {
    pduCaenNevisPM5VTemp_ = v;
  }
  inline uint16_t PduCaenNevisPM5VTemp() const {
    return pduCaenNevisPM5VTemp_;
  }

  inline void setPduCaenNevisP12VTemp(uint16_t v) {
    pduCaenNevisP12VTemp_ = v;
  }
  inline uint16_t PduCaenNevisP12VTemp() const {
    return pduCaenNevisP12VTemp_;
  }

  inline void setPduCaenNevisP3V3Temp(uint16_t v) {
    pduCaenNevisP3V3Temp_ = v;
  }
  inline uint16_t PduCaenNevisP3V3Temp() const {
    return pduCaenNevisP3V3Temp_;
  }

  inline void setPduShaperTemp(uint16_t v) {
    pduShaperTemp_ = v;
  }
  inline uint16_t PduShaperTemp() const {
    return pduShaperTemp_;
  }

  inline void setPduShaperM3V3Vol(uint16_t v) {
    pduShaperM3V3Vol_ = v;
  }
  inline uint16_t PduShaperM3V3Vol() const {
  ...
  inline uint16_t PduCpuUnusedCur() const {
  ...
  inline uint16_t PressureRegulatorVol() const {
    return pressureRegulatorVol_;
  }

  inline void setPduTofP12VTemp(uint16_t v) {
    pduTofP12VTemp_ = v;
  }
  inline uint16_t PduTofP12VTemp() const {
    return pduTofP12VTemp_;
  }

  inline void setPduCurMainBat(uint16_t v) {
    pduCurMainBat_ = v;
  }
  inline uint16_t PduCurMainBat() const {
    return pduCurMainBat_;
  }

  inline void setPduVolMainBat(uint16_t v) {
    pduVolMainBat_ = v;
  }
  inline uint16_t PduVolMainBat() const {
    return pduVolMainBat_;
  }

  inline void setPduMainBatTemp(uint16_t v) {
    pduMainBatTemp_ = v;
  }
  inline uint16_t PduMainBatTemp() const {
    return pduMainBatTemp_;
  }
  ...
  inline uint16_t RtdTofFpga() const {
    return rtdTofFpga_;
  }

  inline void setRtdTof(uint16_t v) {
    rtdTof_ = v;
  }
  inline uint16_t RtdTof() const {
    return rtdTof_;
  }
  ...
  inline uint32_t StorageSize() const {
    return storageSize_;
  }

  inline void setCpuTemperature(uint16_t v) {
    cpuTemperature_ = v;
  }
  inline uint16_t CpuTemperature() const {
    return cpuTemperature_;
  }

  inline void setRamUsage(uint16_t v) {
    ramUsage_ = v;
  }
  inline uint16_t RamUsage() const {
    return ramUsage_;
  }
};
