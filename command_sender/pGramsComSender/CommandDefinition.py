...
command_collection.add_command("TOF", CommandItem("Macro Auto Run Sequence", ""))
command_collection.add_command("TOF", CommandItem("Macro Pre Bias Prep", ""))
command_collection.add_command("TOF", CommandItem("Macro Post Bias Prep", ""))
command_collection.add_command("TOF", CommandItem("Macro Cyclic Run Loop", ""))
