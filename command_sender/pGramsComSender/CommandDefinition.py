...
command_collection.add_command("Hub", CommandItem("Cold TPC HV ON", ""))
command_collection.add_command("Hub", CommandItem("Cold TPC HV OFF", ""))
command_collection.add_command("Hub", CommandItem("Cold Charge PreAmp ON", ""))
command_collection.add_command("Hub", CommandItem("Cold Charge PreAmp OFF", ""))
command_collection.add_command("Hub", CommandItem("Cold SiPM PreAmp ON", ""))
command_collection.add_command("Hub", CommandItem("Cold SiPM PreAmp OFF", ""))
command_collection.add_command("Hub", CommandItem("Warm TPC Shaper ON", ""))
command_collection.add_command("Hub", CommandItem("Warm TPC Shaper OFF", ""))
command_collection.add_command("Hub", CommandItem("SiPM 0 ON", ""))
command_collection.add_command("Hub", CommandItem("SiPM 0 OFF", ""))
command_collection.add_command("Hub", CommandItem("SiPM 1 ON", ""))
command_collection.add_command("Hub", CommandItem("SiPM 1 OFF", ""))
command_collection.add_command("Hub", CommandItem("SiPM 2 ON", ""))
command_collection.add_command("Hub", CommandItem("SiPM 2 OFF", ""))
command_collection.add_command("Hub", CommandItem("SiPM 3 ON", ""))
command_collection.add_command("Hub", CommandItem("SiPM 3 OFF", ""))
command_collection.add_command("Hub", CommandItem("SiPM 4 ON", ""))
command_collection.add_command("Hub", CommandItem("SiPM 4 OFF", ""))
command_collection.add_command("Hub", CommandItem("SiPM 5 ON", ""))
command_collection.add_command("Hub", CommandItem("SiPM 5 OFF", ""))
command_collection.add_command("Hub", CommandItem("Tof ON", ""))
command_collection.add_command("Hub", CommandItem("Tof OFF", ""))
command_collection.add_command("Hub", CommandItem("CAEN P3V3 ON", ""))
command_collection.add_command("Hub", CommandItem("CAEN P3V3 OFF", ""))
command_collection.add_command("Hub", CommandItem("CAEN PM5V ON", ""))
command_collection.add_command("Hub", CommandItem("CAEN PM5V OFF", ""))
command_collection.add_command("Hub", CommandItem("CAEN P12V ON", ""))
command_collection.add_command("Hub", CommandItem("CAEN P12V OFF", ""))
command_collection.add_command("Hub", CommandItem("DAQ CPU ON", ""))
command_collection.add_command("Hub", CommandItem("DAQ CPU OFF", ""))
command_collection.add_command("Hub", CommandItem("SiPM0 VSET", "", [CommandParameter("Voltage")]))
command_collection.add_command("Hub", CommandItem("SiPM1 VSET", "", [CommandParameter("Voltage")]))
command_collection.add_command("Hub", CommandItem("SiPM2 VSET", "", [CommandParameter("Voltage")]))
command_collection.add_command("Hub", CommandItem("SiPM3 VSET", "", [CommandParameter("Voltage")]))
command_collection.add_command("Hub", CommandItem("SiPM4 VSET", "", [CommandParameter("Voltage")]))
command_collection.add_command("Hub", CommandItem("SiPM5 VSET", "", [CommandParameter("Voltage")]))
command_collection.add_command("Hub", CommandItem("PressureReg VSET", "", [CommandParameter("voltage")]))
...
command_collection.add_command("TOF", CommandItem("Process Coin Evt QA", ""))
